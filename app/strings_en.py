...
notification_paid_disabled = '🔕 Notifications about payment are disabled'
notification_paid_enabled = '🔔 Notifications about payment are enabled'
notification_paid_alert = '💰 A payment was made'
